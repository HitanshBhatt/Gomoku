...
def is_bounded(board, y_end, x_end, length, d_y, d_x):
    if (d_y == 0 and d_x == 1):
        if x_end <= 8 and board[y_end][x_end] == " ":
            return "OPEN"
        elif x_end > 8 and (board[y_end][x_end] == "w" or board[y_end][x_end] == "b"):
            return "CLOSED"
        else:
            return "SEMI-OPEN"
    elif (d_y == 1 and d_x == 0):
        if y_end <= 8 and board[y_end][x_end] == " ":
            return "OPEN"
        elif y_end > 8 and (board[y_end][x_end] == "w" or board[y_end][x_end] == "b"):
            return "CLOSED"
        else:
            return "SEMI-OPEN"
    elif (d_y == 1 and d_x == 1):
        if y_end <= 8 and x_end <= 8 and board[y_end][x_end] == " ":
            return "OPEN"
        elif x_end > 8 and y_end > 8 and (board[y_end][x_end] == "w" or board[y_end][x_end] == "b"):
            return "CLOSED"
        else:
            return "SEMI-OPEN"
    elif (d_y == 1 and d_x == -1):
